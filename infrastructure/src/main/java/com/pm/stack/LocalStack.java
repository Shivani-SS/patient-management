...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService","auth-service",
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET","ff2645d80fd1008a90718e12e9e19df1953ee61aae54e3fc10abf3cbf8482e94"));
    ...
    private FargateService createFargateService(String id,
        ...
        envVars.put("SPRING_KAFKA_BOOTSTRAP_SERVERS", "localhost.localstack.cloud:4510, localhost.localstack.cloud:4511, localhost.localstack.cloud:45102");
